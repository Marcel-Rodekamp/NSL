...
void bench_exp_cube_M(int nt, int nx){
    ...
    std::ofstream fout; 
    fout.open("results_bench_exp_cube_M.txt", std::ios::out | std::ios::app);
...
void bench_exp_cube_MdaggerM(int nt, int nx){
    ...
    std::cout << "Estimated Time [s] for function call to MdaggerM: "<<timings<<std::endl;
        ...
        std::ofstream fout; 
    fout.open("results_bench_exp_cube_MdaggerM.txt", std::ios::out | std::ios::app);
    fout<<nt<<" "<<nx<<" "<<" "<<timings<<std::endl;
    fout.close();
...
void bench_exp_cube_logDetM(int nt, int nx){
    ...
    std::ofstream fout; 
    fout.open("results_bench_exp_cube_logDetM.txt", std::ios::out | std::ios::app);
    fout<<nt<<" "<<nx<<" "<<" "<<timings<<std::endl;
    fout.close();
