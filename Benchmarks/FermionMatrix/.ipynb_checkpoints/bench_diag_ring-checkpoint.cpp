...
void bench_diag_ring_M(int nt, int nx){
    ...
    std::string filename;
    filename = "results/results_bench_diag_ring_M_nx_" + std::to_string(nx) + ".txt"; 
    std::ofstream fout; 
...
void bench_diag_ring_MdaggerM(int nt, int nx){
    ...
    std::cout<< "Estimated bandwidth: "<<est_bw<<std::endl;
    std::string filename;
    filename = "results/results_bench_diag_ring_MdaggerM_nx_" + std::to_string(nx) + ".txt"; 
...
void bench_diag_ring_logDetM(int nt, int nx){
    ...
    std::cout<< "Estimated bandwidth: "<<est_bw<<std::endl; 
    std::string filename;
    filename = "results/results_bench_diag_ring_logDetM_nx_" + std::to_string(nx) + ".txt"; 
