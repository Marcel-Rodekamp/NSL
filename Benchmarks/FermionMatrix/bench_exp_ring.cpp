...
void bench_exp_ring_M(int nt, int nx){
    ...
    std::ofstream fout; 
    fout.open("bench_exp_ring_M.txt", std::ios::out | std::ios::app);
...
void bench_exp_ring_MdaggerM(int nt, int nx){
    ...
    std::ofstream fout; 
    fout.open("bench_exp_ring_MdaggerM.txt", std::ios::out | std::ios::app);
    fout<<nt<<" "<<nx<<" "<<" "<<timings<<std::endl;
    fout.close();
...
void bench_exp_ring_logDetM(int nt, int nx){
    ...
    std::ofstream fout; 
    fout.open("bench_exp_ring_logDetM.txt", std::ios::out | std::ios::app);
    fout<<nt<<" "<<nx<<" "<<" "<<timings<<std::endl;
    fout.close();
