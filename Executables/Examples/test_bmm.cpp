...
int main(int argc, char* argv[]){
    ...
    params["test_N"] = yml["system"]["test_N"].as<NSL::size_t>();
    ...
    // Custom implementation of allclose
    ...
    std::cout << "First action val: " << act_val << std::endl;
    std::cout << "Second action val: " << act_val2 << std::endl;
