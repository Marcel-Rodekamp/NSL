#ifndef NSL_FERMION_MATRIX_HUBBARD_EXP_SPIN_BASIS_TPP
#define NSL_FERMION_MATRIX_HUBBARD_EXP_SPIN_BASIS_TPP
...
template<NSL::Concept::isNumber Type, NSL::Concept::isDerived<NSL::Lattice::SpatialLattice<Type>> LatticeType>
NSL::Tensor<Type> NSL::FermionMatrix::HubbardExpSpinBasis<Type,LatticeType>::M(const NSL::Tensor<Type> & psi){
...
template<NSL::Concept::isNumber Type, NSL::Concept::isDerived<NSL::Lattice::SpatialLattice<Type>> LatticeType>
Type NSL::FermionMatrix::HubbardExpSpinBasis<Type,LatticeType>::logDetM(){
...
template<NSL::Concept::isNumber Type, NSL::Concept::isDerived<NSL::Lattice::SpatialLattice<Type>> LatticeType>
void NSL::FermionMatrix::HubbardExpSpinBasis<Type,LatticeType>::printMatrix(const NSL::Tensor<Type> & vu, std::string name, int prec){
...
template<NSL::Concept::isNumber Type, NSL::Concept::isDerived<NSL::Lattice::SpatialLattice<Type>> LatticeType>
NSL::Tensor<Type> NSL::FermionMatrix::HubbardExpSpinBasis<Type,LatticeType>::gradLogDetM(){
    //ToDo: implement
...
#endif //NSL_FERMION_MATRIX_HUBBARD_EXP_SPIN_BASIS_TPP
