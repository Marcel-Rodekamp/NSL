...
namespace NSL::Action::U1
{
    ...
    {
    public:
        WilsonGaugeAction(NSL::Parameter &params) : BaseAction<Type, Type>("U"),
                                                    params_(params),
                                                    beta_(params["beta"])
        {
        }

        WilsonGaugeAction(NSL::Parameter &params, const std::string &fieldName) : BaseAction<Type, Type>(fieldName),
                                                                                  params_(params),
                                                                                  beta_(params["beta"])
        {
        }
